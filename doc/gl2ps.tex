...
%
%  $Id: gl2ps.tex,v 1.23 2001-11-19 11:02:11 geuzaine Exp $
% 
...
strings of the plot and including a graphic file having the same basename as
\dd{filename}. In order to avoid duplicate text strings, the graphic file
should be generated with the \dd{GL2PS_NO_TEXT} option.
...
primitives. New options for LaTeX output.
\end{description}
