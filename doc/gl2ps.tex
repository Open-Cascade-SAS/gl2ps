...
%
%  $Id: gl2ps.tex,v 1.2 2001-05-23 14:14:24 geuzaine Exp $
% 
...
\author{Christophe Geuzaine}
\date{Version 0.32, 13 November 2000}

\maketitle

%%tth:\section*{Download}
%%tth:The current archive of the package is available
%%tth:\href{http://www.geuz.org/gl2ps/gl2ps-0.32.tar.gz}{here}.
...
\item[0.32] Fixed memory leaks, thanks to Bart Kaptein <B.L.Kaptein@lumc.nl>
% Occlusion culling.
\end{description}
