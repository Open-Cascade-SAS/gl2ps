...
%
%  $Id: gl2ps.tex,v 1.60 2003-01-17 05:54:11 geuzaine Exp $
% 
...
\begin{itemize}
\item 
Rendering large and/or complicated scenes is slow, and will always be. But
vector-based images are not destined to replace bitmaps! They just offer an
alternative when high quality (especially for 2D and small 3D plots) and
ease of manipulation (how do you change the scale, the labels or the colors
in a bitmap picture long after the picture was produced, and without
altering its quality?) are important.
\item
