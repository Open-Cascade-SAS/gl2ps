...
%
%  $Id: gl2ps.tex,v 1.98 2003-06-10 19:22:13 geuzaine Exp $
% 
...
(``major.minor.patch'').
\item[0.9.1] (Jun 10, 2003) Fixed two \LaTeX\ output bugs (\dd{glRenderMode}
not reset to \dd{GL_RENDER}; crash when printing an empty scene); changed
default pixmap depth to 8 bits per color component.
\end{description}
