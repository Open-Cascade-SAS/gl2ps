...
%
%  $Id: gl2ps.tex,v 1.31 2002-02-15 00:23:27 geuzaine Exp $
% 
...
\author{Christophe Geuzaine}
\date{Version 0.52, 14 February 2002}

\maketitle

%%tth: \section*{Download}
%%tth: The current distribution of GL2PS is available either as a
%%tth: \href{http://www.geuz.org/gl2ps/gl2ps-0.52.tar.gz}{tar.gz}
%%tth: or as a 
%%tth: \href{http://www.geuz.org/gl2ps/gl2ps-0.52.zip}{zip}
...
landscape option implementation.
...
\item[0.52] (Feb 14, 2002) New \dd{GL2PS_LANDSCAPE} option. Other minor
changes.
\end{description}
