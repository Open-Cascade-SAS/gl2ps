...
%
%  $Id: gl2ps.tex,v 1.5 2001-06-11 11:10:06 geuzaine Exp $
% 
...
\begin{description}
\item[\dd{GL2PS_POLYGON_OFFSET_FILL}] Tries to mimmic the
...
\item[\dd{GL2PS_LINE_STIPPLE}] Tries to mimmic the
...
\dd{gl2psPointSize} and \dd{gl2psLineSize} mimmic the 
\dd{glPointSize} and the \dd{glLineWidth} functionnality.
