...
%
%  $Id: gl2ps.tex,v 1.97 2003-06-10 19:14:12 geuzaine Exp $
% 
...
(``major.minor.patch'').
\item[0.9.1] (Jun 10, 2003) Fixed a couple of bugs for \LaTeX\ output
(\dd{glRenderMode} not reset to \dd{GL_RENDER}; crash when printing an empty
scene); set default pixmap bit depth to 8.
\end{description}
