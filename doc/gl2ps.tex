...
%
%  $Id: gl2ps.tex,v 1.89 2003-03-22 16:15:42 geuzaine Exp $
% 
...
\author{Christophe Geuzaine}
\date{Version 0.81, 21 March 2003}

\maketitle

%%tth: \section*{Download}
%%tth: The current distribution of GL2PS is available either as a
%%tth: \href{http://www.geuz.org/gl2ps/src/gl2ps-0.81.tar.gz}{tar.gz}
%%tth: or as a 
%%tth: \href{http://www.geuz.org/gl2ps/src/gl2ps-0.81.zip}{zip}
...
\item[0.81] (Mar 21, 2003) Fixed small typos in comments and documentation.
\end{description}
