...
%
%  $Id: gl2ps.tex,v 1.33 2002-03-08 18:05:23 geuzaine Exp $
% 
...
\author{Christophe Geuzaine}
\date{Version 0.53, 8 March 2002}

\maketitle

%%tth: \section*{Download}
%%tth: The current distribution of GL2PS is available either as a
%%tth: \href{http://www.geuz.org/gl2ps/gl2ps-0.53.tar.gz}{tar.gz}
%%tth: or as a 
%%tth: \href{http://www.geuz.org/gl2ps/gl2ps-0.53.zip}{zip}
...
\item[0.53] (Mar 8, 2002) New \dd{GL2PSDLL} compilation flag to allow the
