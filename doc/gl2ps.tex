...
%
%  $Id: gl2ps.tex,v 1.99 2003-06-10 19:27:38 geuzaine Exp $
% 
...
%
\email{Rouben Rostamian}{rostamian@umbc.edu} for various bug fixes;
%
...
%
\email{Prabhu Ramachandran}{prabhu@aero.iitm.ernet.in} for various bug
reports.
...
(``major.minor.patch'').
\item[0.9.1] (Jun 10, 2003) Fixed two \dd{GL2PS_TEX} output bugs
(\dd{glRenderMode} not reset to \dd{GL_RENDER} and crash when printing empty
scene); changed default pixmap depth to 8 bits per color component.
\end{description}
