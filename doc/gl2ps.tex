...
%
%  $Id: gl2ps.tex,v 1.51 2002-12-11 16:37:53 geuzaine Exp $
% 
...
\author{Christophe Geuzaine}
\date{Version 0.7, ?? December 2002}

\maketitle

%%tth: \section*{Download}
%%tth: The current distribution of GL2PS is available either as a
%%tth: \href{http://www.geuz.org/gl2ps/gl2ps-0.7.tar.gz}{tar.gz}
%%tth: or as a 
%%tth: \href{http://www.geuz.org/gl2ps/gl2ps-0.7.zip}{zip}
...
\item[0.7] (Dec ??, 2002) Occlusion culling (\dd{GL2PS_OCCLUSION_CULL}) is
back; enhanced \dd{GL2PS_BEST_ROOT}.
\end{description}
