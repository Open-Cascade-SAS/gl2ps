...
%
%  $Id: gl2ps.tex,v 1.59 2003-01-17 00:42:07 geuzaine Exp $
% 
...
\author{Christophe Geuzaine}
\date{Version 0.72, 16 January 2002}
...
\begin{itemize}
\item 
Rendering large and/or complicated scenes is slow, and will always
be. Vector-based images are not destined to replace bitmaps. They just offer
an alternative when high quality (especially for 2D and small 3D plots) and
ease of manipluation are important. Think for example about reusing a
picture from a scientific paper you published a couple of years years ago,
when you need to modify the labels, rescale the plot, change the colors,
etc.
\item
Transparency is not supported yet. See the \dd{TODO} file for some insight
on this topic.
\item
...
\item[0.72] (Jan 16, 2002) Enhanced documentation.
\end{description}
