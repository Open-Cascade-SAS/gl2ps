...
%
%  $Id: gl2ps.tex,v 1.46 2002-11-11 23:40:03 geuzaine Exp $
% 
...
\author{Christophe Geuzaine}
\date{Version 0.63, ?? December 2002}
...
is set. The arguments \dd{nr}, \dd{ng} and \dd{nb} represent the number of
values used for interpolating the full range of red, green and blue color
components. A triangle is thus recursively subdivided until the color
difference between to vertices is smaller that $1/\mathtt{nr}$ for the red
component, $1/\mathtt{ng}$ for the green component and $1/\mathtt{nb}$ for
the blue component. The last call before \dd{gl2psEndPage} is the one taken
into account.
...
\item[0.63] (Dec ??, 2002) Changed GLvoid to void; revised documentation.
\end{description}
