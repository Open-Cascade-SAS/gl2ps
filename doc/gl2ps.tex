...
%
%  $Id: gl2ps.tex,v 1.45 2002-09-06 21:33:01 geuzaine Exp $
% 
...
shaded triangles with small flat-shaded ones (either when the \dd{shfill}
operator is not supported by the system, or when the
