...
%
%  $Id: gl2ps.tex,v 1.18 2001-10-12 17:53:10 geuzaine Exp $
% 
...
%%tth: \special{html:<LINK href="/general.css" rel="stylesheet">}
%%tth: \special{html:<BODY>}

\title{GL2PS, an OpenGL to Postscript Printing Library}
\author{Christophe Geuzaine}
\date{Version 0.42, 8 October 2001}

\maketitle

%%tth: \section*{Download}
%%tth: The current distribution of GL2PS is available either as a
%%tth: \href{http://www.geuz.org/gl2ps/gl2ps-0.42.tar.gz}{tar.gz}
%%tth: or as a 
%%tth: \href{http://www.geuz.org/gl2ps/gl2ps-0.42.zip}{zip}
