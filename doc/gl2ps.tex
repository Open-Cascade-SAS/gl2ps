...
%
%  $Id: gl2ps.tex,v 1.58 2003-01-13 01:57:31 geuzaine Exp $
% 
...
\author{Christophe Geuzaine}
\date{Version 0.71, 13 December 2002}

\maketitle

%%tth: \section*{Download}
%%tth: The current distribution of GL2PS is available either as a
%%tth: \href{http://www.geuz.org/gl2ps/src/gl2ps-0.71.tar.gz}{tar.gz}
%%tth: or as a 
%%tth: \href{http://www.geuz.org/gl2ps/src/gl2ps-0.71.zip}{zip}
...
A complete example can be found in the distribution in the file
\dd{gl2psTest.c}.
...
% \label{sec:bugs}
%
% We can only capture what's in the feedback buffer. All the stuff applied in
% the pipeline after the creation of the feedback buffer has to be duplicated
% in gl2ps (fonts, polygon offset, line stipple, etc.)
%
% Rendering large/complicated scenes is slow, and will always be. Vector-based
% images (and thus gl2ps) are not to replace bitmaps. They just offer high
% quality (especially for 2D and small 3D) and ease of manipluation (e.g.\
% think about reusing a picture from a paper you published 3 years ago, when
% you need to modify the labels, rescale the plot, change the colors, etc.).
%
% No transparency yet. See TODO file for a discussion.
%
% No textures, fog, volumic rendering, etc.
