...
%
%  $Id: gl2ps.tex,v 1.70 2003-02-27 18:15:35 geuzaine Exp $
% 
...
\author{Christophe Geuzaine}
\date{Version 0.74, ?? March 2003}

\maketitle

%%tth: \section*{Download}
%%tth: The current distribution of GL2PS is available either as a
%%tth: \href{http://www.geuz.org/gl2ps/src/gl2ps-0.74.tar.gz}{tar.gz}
%%tth: or as a 
%%tth: \href{http://www.geuz.org/gl2ps/src/gl2ps-0.74.zip}{zip}
...
\item[0.74] (Mar ??, 2003) Fix small memory leak in occlusion culling.
\end{description}
