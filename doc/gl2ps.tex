...
%
%  $Id: gl2ps.tex,v 1.21 2001-10-31 10:55:37 geuzaine Exp $
% 
...
\author{Christophe Geuzaine}
\date{Version 0.43, 31 October 2001}

\maketitle

%%tth: \section*{Download}
%%tth: The current distribution of GL2PS is available either as a
%%tth: \href{http://www.geuz.org/gl2ps/gl2ps-0.43.tar.gz}{tar.gz}
%%tth: or as a 
%%tth: \href{http://www.geuz.org/gl2ps/gl2ps-0.43.zip}{zip}
...
optimization; Sam Buss (\email{sbuss@ucsd.edu}) for the smooth shaded
triangle code.
...
\item[0.43] (Oct 31, 2001) Better support of smooth shaded primitives.
\end{description}
