...
%
%  $Id: gl2ps.tex,v 1.54 2002-12-13 04:53:11 geuzaine Exp $
% 
...
\author{Christophe Geuzaine}
\date{Version 0.7, 11 December 2002}

\maketitle

%%tth: \section*{Download}
%%tth: The current distribution of GL2PS is available either as a
%%tth: \href{http://www.geuz.org/gl2ps/src/gl2ps-0.7.tar.gz}{tar.gz}
%%tth: or as a 
%%tth: \href{http://www.geuz.org/gl2ps/src/gl2ps-0.7.zip}{zip}
