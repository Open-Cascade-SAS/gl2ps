...
%
%  $Id: gl2ps.tex,v 1.83 2003-03-06 03:08:11 geuzaine Exp $
% 
...
separately and has its own backgound frame. The argument given to
...
font rendering, polygon offset or line stippling---see
sections~\ref{sec:gl2psText}, \ref{sec:gl2psEnable} and
\ref{sec:gl2psPointSize}).
