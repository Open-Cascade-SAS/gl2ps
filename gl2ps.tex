...
'<code>svn co <a href="https://geuz.org/svn/gl2ps/trunk" data-tooltip=
 "Login and password: gl2ps">https://geuz.org/svn/gl2ps/trunk</a> gl2ps</code>'.
<p>
...
href="https://geuz.org/trac/gl2ps/newticket" data-tooltip="Login and password:
gl2ps">here</a>. You can also subscribe to the <a
...
improvement, image scaling fix for SVG output, PostScript viewport color bug
fix;
%
...
\item[1.3.10] Make it possible to add primitives directly, without parsing the
  OpenGL feedback buffer, using \dd{gl2psAddPolyPrimitive}; \dd{gl2psBeginPage}
  now accepts a buffersize of 0; new \dd{gl2psForceRasterPos}.
\end{description}
